          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-white rounded-card border border-blue-brand/10 p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-gray-600 mb-1">Years of local guiding / hosting experience</label>
                  <input
                    type="number" min="0" max="50" className="input-field text-sm w-32"
            ...
            <div className="bg-blue-tint rounded-card p-4 text-xs text-gray-500 leading-relaxed">
              By applying, you confirm that all information provided is accurate. Vtopia reserves the right to review and approve all guide applications. Approved guides are subject to our{' '}
