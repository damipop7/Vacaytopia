    ...
    try {
      ...
      if (interestTags.length > 0) {
        const { data: matched, error: matchErr } = await supabase
          .from("experiences")
          .select(`id, title, city, category, price_per_person, duration_label, rating, review_count, image_emoji, image_gradient, is_sponsored, tags, guides:guide_id (first_name, rating)`)
